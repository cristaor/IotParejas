...
int dht_dpin = 0;         //Pin donde se lee valor del LDR A0
...
void loop()
{
  ...
  //invoca la funcion de conversion a intensidad luminica
  double intensity = getLightIntensity(lectura, resistencia);
  ...
  String json = "{\"value\": "+ String(intensity) + "}";
